...
export const cursorStats = {
  'Total Users': '8M',
  'Retention Rate': '71%',
  'YoY Growth': '400%'
};

export const juniorPerspective = {
  'Productivity': '+200%',
...
export const seniorPerspective = {
  'Productivity': '+20%',
  'Code Quality': 'Concerned',
  'Job Security': 'Not worried',
...
<DataVisualization 
  type="pie" 
  data={marketShare} 
  title="AI Code Generation Market Share 2025"
  className="mb-6"
/>
...
**Key insights:**
- Amazon CodeWhisperer: 3.5M users (45% retention) - free tier driving adoption
- Tabnine: 2M users focused on enterprise/on-premises solutions
- **The surprise: 40% of developers NOT using any AI tools**

### The Productivity Reality

Real metrics from real companies:

export const productivityStudyResults = {
  'Code Written': '+47% (lines of code)',
  'Quality': '-23% (bug rate increase)',
  'Time Saved - Boilerplate': '78% reduction',
  'Time Saved - Algorithms': '31% reduction',
  'Time Saved - Debugging': '-15% (got worse)'
};

export const developerSatisfaction = {
  'Junior Devs': '92% positive',
  'Senior Devs': '41% positive',
  'Architects': '23% positive'
};

export const productivityStudyMeta = {
  'Participants': '10,000 developers',
  'Duration': '12 months',
  'Key Finding': 'Developers write more code but solve fewer problems'
};

<DataVisualization 
  type="bar" 
  data={productivityStudyResults} 
  title="Productivity Impact Study Results"
  className="mb-4"
/>

<DataVisualization 
  type="bar" 
  data={developerSatisfaction} 
  title="Developer Satisfaction by Experience Level"
  className="mb-4"
/>

<DataVisualization 
  type="stats" 
  data={productivityStudyMeta} 
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
  <div>
    <DataVisualization 
      type="stats" 
      data={juniorPerspective} 
      title="Junior Developer (2 years experience)"
    />
    <p className="mt-4 italic text-gray-600 dark:text-gray-400">
      "I can build features that would have taken weeks"
    </p>
  </div>
  ...
  <div>
    <DataVisualization 
      type="stats" 
      data={seniorPerspective} 
      title="Senior Developer (15 years experience)"
    />
    <p className="mt-4 italic text-gray-600 dark:text-gray-400">
      "Juniors using AI without understanding is terrifying"
    </p>
  </div>
</div>
