...
export const projectLanguageShare = {
  'TypeScript': 42,
  'Python': 23,
  'Go': 14,
  'Java': 8,
...
export const repoGrowth = {
  'TypeScript': '2.8M new repos',
  'Go': '567K new repos',
  'Rust': '89K new repos'
};
...
<DataVisualization 
  type="pie" 
  data={projectLanguageShare} 
  title="New Project Language Selection (2025)"
  className="mb-6"
/>
...
<DataVisualization 
  type="stats" 
  data={repoGrowth} 
  title="GitHub New Repositories (Q1 2025)"
  className="mb-6"
/>
...
**Dominant Domains:**
- **TypeScript**: Web, backend, CLI tools, mobile apps
- **Go**: Cloud infrastructure, DevOps, microservices
- **Rust**: Systems programming, blockchain, WebAssembly
