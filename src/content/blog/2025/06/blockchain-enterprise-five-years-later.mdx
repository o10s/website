...
export const blockchainOutcomes = {
  'Total POCs Launched': 8947,
  'Reached Pilot': 2341,
  'Reached Production': 423,
  'Still Active 2025': 127,
  'Delivering ROI': 34
};
...
export const projectStats = {
  'Average POC Cost': '$847,000',
  'Average Time to Failure': '8 months',
  'Most Common Excuse': 'Regulatory concerns'
};
...
<DataVisualization 
  type="bar" 
  data={blockchainOutcomes} 
  title="Blockchain Project Outcomes (out of 8,947 POCs)"
  className="mb-6"
/>
...
<DataVisualization 
  type="pie" 
  data={moneySpent} 
  title="Money Spent on Blockchain Initiatives"
  className="mb-6"
/>
